...
plt.scatter(data['time[µs]'], data['position'], color='b', label='Position', s=0.1)
...
output_file = 'test_2.1/position_vs_time_scatter.png'  # You can change the file name and format as needed
